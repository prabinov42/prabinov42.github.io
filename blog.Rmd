...
I am thinking here of typical businesses who do not have a gazillion data scientists, but do have a few, who are charged with help making business decisions. You know, statsy people. I am not thinking of 'full stack' data scientists, or writing pipelines or data stores, or frameworks. Just using data to make business decisions. 

### All businesses?

And I'm excluding businesses where there are very precisely defined metrics that are (more less) legally required: finance, health, insurance, etc.

### Just data science?

Maybe. Maybe not. I am focusing on ds because that is what I know and have seen - but it wouldn't surprise me in the least if many other areas will face similar reckonings.

### How would you go about building this?

Obviously, I'd ask ChatGPT how to do so. It's reply was interesting - among other (somewhat obvious and useful) suggestions, it said "Critical Design Principle: Never let the LLM directly interpret raw data or perform inference internally. Always: LLM proposes → R computes → LLM explains"

ChatGPT is demonstrating more self-awareness than some people I know!

So after some more conversations, we came up with this https://prabinov42.github.io/posts/autods/


### But but but AI will eliminate jobs and is evil!

AI can do both amazing things and horrible things. Both.

Regardless, AI will continue to be developed because there is money to be made. Even if a bunch of countries ban/regulate AI, there are others who won't, and so it will be developed there. In other words, more AI is coming.

So what we need to do is use it for what it is good for, while at the same time trying to put up guardrails, not use it for evil, understand its weaknesses, and mitigate its misuse.
